<template>
  <div class="container">
    <!-- <view class="list" v-for="(items,index) in bookList" :key="index">
      ...
      <view class="middle">
        ...
        <view class="text">
          ...
          <p class="price">￥ {{items.book_price}}</p>
        </view>
      </view>

      <view class="right">
        <view class="count">
          <view @click="sub" :class="(islight ? 'light' : '') + ' sub'">-</view>
<<<<<<< HEAD
    <view class="num">{{items.count}}</view>-->
    <!--  -->
    ...
    <view class="list">
      ...
      <view class="middle">
        ...
        <view class="text">
          <p class="name">《items.book_name》</p>
...
>>>>>>> 2e67f31cf8bb8ddcf695771f0a141f7efb52a055
          <p class="price">￥ items.book_price</p>
        </view>
      </view>
      <view class="right">
